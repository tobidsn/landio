        ...
        var r = !1,
            ...
            l = {
                ...
                getSelectorFromElement: function t(e) {
                    ...
                    return i || (i = e.getAttribute("href") || "", i = /^#[a-z]/i.test(i) ? i : null), i
                },
                reflow: function t(e) {
                ...
                typeCheckConfig: function i(n, s, o) {
                    for (var r in o)
                        if (o.hasOwnProperty(r)) {
                            var a = o[r],
                                l = s[r],
                                h = void 0;
                            if (h = l && e(l) ? "element" : t(l), !new RegExp(a).test(h)) throw new Error(n.toUpperCase() + ": " + ('Option "' + r + '" provided type "' + h + '" ') + ('but expected type "' + a + '".'))
                        }
                }
            };
        return o(), l
        ...
        var t = "carousel",
            ...
            d = function() {
                ...
                return _createClass(s, [{
                    ...
                    key: "pause",
                    value: function t(e) {
                        e || (this._isPaused = !0), $(this._element).find(p.NEXT_PREV)[0] && Util.supportsTransitionEnd() && (Util.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                    }
                }, {
                    key: "cycle",
                    value: function t(e) {
                        e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval($.proxy(document.visibilityState ? this.nextWhenVisible : this.next, this), this._config.interval))
                    }
                }, {
                    key: "to",
                    value: function t(e) {
                    ...
                    key: "_getConfig",
                    value: function e(i) {
                        return i = $.extend({}, a, i), Util.typeCheckConfig(t, i, l), i
                    }
                }, {
                    ...
                    value: function t(e, i) {
                        var n = e === h.NEXT,
                            ...
                            a = s && 0 === o || n && o === r;
                        if (a && !this._config.wrap) return i;
                        var l = e === h.PREVIOUS ? -1 : 1,
                            c = (o + l) % this._items.length;
                    ...
                    value: function t(e, i) {
                        var n = this,
                            s = $(this._element).find(p.ACTIVE_ITEM)[0],
                            o = i || s && this._getItemByDirection(e, s),
                            a = Boolean(this._interval),
                            l = e === h.NEXT ? u.LEFT : u.RIGHT;
                        if (o && $(o).hasClass(u.ACTIVE)) return void(this._isSliding = !1);
                        ...
                        if (!d.isDefaultPrevented() && s && o) {
                            ...
                            Util.supportsTransitionEnd() && $(this._element).hasClass(u.SLIDE) ? ($(o).addClass(e), Util.reflow(o), $(s).addClass(l), $(o).addClass(l), $(s).one(Util.TRANSITION_END, function() {
                                $(o).removeClass(l).removeClass(e), $(o).addClass(u.ACTIVE), $(s).removeClass(u.ACTIVE).removeClass(e).removeClass(l), n._isSliding = !1, setTimeout(function() {
                                    return $(n._element).trigger(v)
                                }, 0)
                            }).emulateTransitionEnd(r)) : ($(s).removeClass(u.ACTIVE), $(o).addClass(u.ACTIVE), this._isSliding = !1, $(this._element).trigger(v)), a && this.cycle()
                        }
                    }
                }], [{
                    ...
                    value: function t(e) {
                        return this.each(function() {
                            ...
                            "object" == typeof e && $.extend(n, e);
                            var o = "string" == typeof e ? e : n.slide;
                            if (t || (t = new s(this, n), $(this).data(i, t)), "number" == typeof e) t.to(e);
                            else if ("string" == typeof o) {
                                if (void 0 === t[o]) throw new Error('No method named "' + o + '"');
                                t[o]()
                            } else n.interval && (t.pause(), t.cycle())
                        })
                    }
                }, {
                    ...
                    value: function t(e) {
                        ...
                        if (n) {
                            var o = $(n)[0];
                            if (o && $(o).hasClass(u.CAROUSEL)) {
                                var r = $.extend({}, $(o).data(), $(this).data()),
                                    a = this.getAttribute("data-slide-to");
                                a && (r.interval = !1), s._jQueryInterface.call($(o), r), a && $(o).data(i).to(a), e.preventDefault()
                            }
                        }
                    }
                }, {
                ...
                return _createClass(n, [{
                    ...
                    value: function t() {
                        ...
                        if (!this._isTransitioning && !$(this._element).hasClass(c.IN)) {
                            var s = void 0,
                                o = void 0;
                            if (this._parent && (s = $.makeArray($(p.ACTIVES)), s.length || (s = null)), !(s && (o = $(s).data(i), o && o._isTransitioning))) {
                                var a = $.Event(h.SHOW);
                                if ($(this._element).trigger(a), !a.isDefaultPrevented()) {
                                    s && (n._jQueryInterface.call($(s), "hide"), o || $(s).data(i, null));
                                    var l = this._getDimension();
                                    $(this._element).removeClass(c.COLLAPSE).addClass(c.COLLAPSING), this._element.style[l] = 0, this._element.setAttribute("aria-expanded", !0), this._triggerArray.length && $(this._triggerArray).removeClass(c.COLLAPSED).attr("aria-expanded", !0), this.setTransitioning(!0);
                                    var u = function t() {
                                        $(e._element).removeClass(c.COLLAPSING).addClass(c.COLLAPSE).addClass(c.IN), e._element.style[l] = "", e.setTransitioning(!1), $(e._element).trigger(h.SHOWN)
                                    };
                                    if (!Util.supportsTransitionEnd()) return void u();
                                    var d = l[0].toUpperCase() + l.slice(1),
                                        v = "scroll" + d;
                                    $(this._element).one(Util.TRANSITION_END, u).emulateTransitionEnd(r), this._element.style[l] = this._element[v] + "px"
                                }
                            }
                        }
                    }
                    ...
                    value: function t() {
                        ...
                        if (!this._isTransitioning && $(this._element).hasClass(c.IN)) {
                            ...
                            if ($(this._element).trigger(i), !i.isDefaultPrevented()) {
                                ...
                                this._element.style[n] = this._element[s] + "px", Util.reflow(this._element), $(this._element).addClass(c.COLLAPSING).removeClass(c.COLLAPSE).removeClass(c.IN), this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && $(this._triggerArray).addClass(c.COLLAPSED).attr("aria-expanded", !1), this.setTransitioning(!0);
                                var o = function t() {
                                    e.setTransitioning(!1), $(e._element).removeClass(c.COLLAPSING).addClass(c.COLLAPSE).trigger(h.HIDDEN)
                                };
                                return this._element.style[n] = 0, Util.supportsTransitionEnd() ? void $(this._element).one(Util.TRANSITION_END, o).emulateTransitionEnd(r) : void o()
                            }
                        }
                    }
                }, {
                    ...
                    key: "_getConfig",
                    value: function e(i) {
                        return i = $.extend({}, a, i), i.toggle = Boolean(i.toggle), Util.typeCheckConfig(t, i, l), i
                    }
                }, {
                    key: "_getDimension",
                    value: function t() {
                        var e = $(this._element).hasClass(u.WIDTH);
                    ...
                    value: function t() {
                        ...
                        return $(i).find(s).each(function(t, i) {
                    ...
                    value: function t(e, i) {
                        if (e) {
                            var n = $(e).hasClass(c.IN);
                            e.setAttribute("aria-expanded", n), i.length && $(i).toggleClass(c.COLLAPSED, !n).attr("aria-expanded", n)
                        }
                    }
                }], [{
                    ...
                    value: function t(e) {
                        return this.each(function() {
                            var t = $(this),
                                s = t.data(i),
                                o = $.extend({}, a, t.data(), "object" == typeof e && e);
                            if (!s && o.toggle && /show|hide/.test(e) && (o.toggle = !1), s || (s = new n(this, o), t.data(i, s)), "string" == typeof e) {
            ...
            h = function() {
                ...
                return _createClass(t, [{
                    ...
                    value: function e() {
                        ...
                        if ("ontouchstart" in document.documentElement && !$(i).closest(l.NAVBAR_NAV).length) {
                            var s = document.createElement("div");
                            s.className = a.BACKDROP, $(s).insertBefore(this), $(s).on("click", t._clearMenus)
                        }
                        var o = {
                                relatedTarget: this
                            },
                            h = $.Event(r.SHOW, o);
                        return $(i).trigger(h), !h.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", "true"), $(i).toggleClass(a.OPEN), $(i).trigger($.Event(r.SHOWN, o)), !1)
                    }
                }, {
                    key: "dispose",
                    value: function t() {
                    ...
                    value: function e(n) {
                        return this.each(function() {
                            var e = $(this).data(i);
                            if (e || $(this).data(i, e = new t(this)), "string" == typeof n) {
                    ...
                    value: function e(i) {
                        if (!i || 3 !== i.which) {
                            ...
                            for (var s = $.makeArray($(l.DATA_TOGGLE)), o = 0; o < s.length; o++) {
                                var h = t._getParentFromElement(s[o]),
                                    c = {
                                        relatedTarget: s[o]
                                    };
                                if ($(h).hasClass(a.OPEN) && !(i && "click" === i.type && /input|textarea/i.test(i.target.tagName) && $.contains(h, i.target))) {
                                    var u = $.Event(r.HIDE, c);
                                    $(h).trigger(u), u.isDefaultPrevented() || (s[o].setAttribute("aria-expanded", "false"), $(h).removeClass(a.OPEN).trigger($.Event(r.HIDDEN, c)))
                                }
                            }
                        }
                    }
                    ...
                    value: function t(e) {
                        ...
                        return n && (i = $(n)[0]), i || e.parentNode
                    }
                }, {
                    key: "_dataApiKeydownHandler",
                    value: function e(i) {
                        if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !$(this).hasClass(a.DISABLED))) {
                            var n = t._getParentFromElement(this),
                                s = $(n).hasClass(a.OPEN);
                            if (!s && 27 !== i.which || s && 27 === i.which) {
                                if (27 === i.which) {
                                    var o = $(n).find(l.DATA_TOGGLE)[0];
                                    $(o).trigger("focus")
                                }
                                return void $(this).trigger("click")
                            }
                            var r = $.makeArray($(l.VISIBLE_ITEMS));
                            if (r = r.filter(function(t) {
                                    return t.offsetWidth || t.offsetHeight
                                }), r.length) {
                                var h = r.indexOf(i.target);
                                38 === i.which && h > 0 && h--, 40 === i.which && h < r.length - 1 && h++, ~h || (h = 0), r[h].focus()
                            }
                        }
                    }
                }, {
            ...
            d = function() {
                ...
                return _createClass(s, [{
                    ...
                    value: function t(e) {
                        ...
                        $(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), $(document.body).addClass(u.OPEN), this._setEscapeEvent(), this._setResizeEvent(), $(this._element).on(c.CLICK_DISMISS, p.DATA_DISMISS, $.proxy(this.hide, this)), $(this._dialog).on(c.MOUSEDOWN_DISMISS, function() {
                            $(i._element).one(c.MOUSEUP_DISMISS, function(t) {
                                $(t.target).is(i._element) && (i._ignoreBackdropClick = !0)
                            })
                    ...
                    value: function t(e) {
                        e && e.preventDefault();
                        var i = $.Event(c.HIDE);
                        $(this._element).trigger(i), this._isShown && !i.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), $(document).off(c.FOCUSIN), $(this._element).removeClass(u.IN), $(this._element).off(c.CLICK_DISMISS), $(this._dialog).off(c.MOUSEDOWN_DISMISS), Util.supportsTransitionEnd() && $(this._element).hasClass(u.FADE) ? $(this._element).one(Util.TRANSITION_END, $.proxy(this._hideModal, this)).emulateTransitionEnd(r) : this._hideModal())
                    }
                }, {
                    key: "dispose",
                    value: function t() {
                    ...
                    key: "_getConfig",
                    value: function e(i) {
                        return i = $.extend({}, l, i), Util.typeCheckConfig(t, i, h), i
                    }
                }, {
                    key: "_showElement",
                    value: function t(e) {
                        var i = this,
                            n = Util.supportsTransitionEnd() && $(this._element).hasClass(u.FADE);
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.scrollTop = 0, n && Util.reflow(this._element), $(this._element).addClass(u.IN), this._config.focus && this._enforceFocus();
                        var s = $.Event(c.SHOWN, {
                                relatedTarget: e
                            }),
                            o = function t() {
                                i._config.focus && i._element.focus(), $(i._element).trigger(s)
                            };
                        n ? $(this._dialog).one(Util.TRANSITION_END, o).emulateTransitionEnd(r) : o()
                    }
                }, {
                    key: "_enforceFocus",
                    value: function t() {
                        var e = this;
                        $(document).off(c.FOCUSIN).on(c.FOCUSIN, function(t) {
                            e._element === t.target || $(e._element).has(t.target).length || e._element.focus()
                        })
                    }
                }, {
                    key: "_setEscapeEvent",
                    value: function t() {
                        var e = this;
                        this._isShown && this._config.keyboard ? $(this._element).on(c.KEYDOWN_DISMISS, function(t) {
                            27 === t.which && e.hide()
                    ...
                    value: function t() {
                        ...
                        this._element.style.display = "none", this._showBackdrop(function() {
                            $(document.body).removeClass(u.OPEN), e._resetAdjustments(), e._resetScrollbar(), $(e._element).trigger(c.HIDDEN)
                        })
                    }
                }, {
                    key: "_removeBackdrop",
                    ...
                    value: function t(e) {
                        var i = this,
                            n = $(this._element).hasClass(u.FADE) ? u.FADE : "";
                        if (this._isShown && this._config.backdrop) {
                            var s = Util.supportsTransitionEnd() && n;
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = u.BACKDROP, n && $(this._backdrop).addClass(n), $(this._backdrop).appendTo(document.body), $(this._element).on(c.CLICK_DISMISS, function(t) {
                                ...
                                }), s && Util.reflow(this._backdrop), $(this._backdrop).addClass(u.IN), !e) return;
                            if (!s) return void e();
                            $(this._backdrop).one(Util.TRANSITION_END, e).emulateTransitionEnd(a)
                        } else if (!this._isShown && this._backdrop) {
                            $(this._backdrop).removeClass(u.IN);
                            var o = function t() {
                                i._removeBackdrop(), e && e()
                            };
                            Util.supportsTransitionEnd() && $(this._element).hasClass(u.FADE) ? $(this._backdrop).one(Util.TRANSITION_END, o).emulateTransitionEnd(a) : o()
                        } else e && e()
                    }
                }, {
                    key: "_handleUpdate",
                    ...
                    key: "_setScrollbar",
                    value: function t() {
                        var e = parseInt($(p.FIXED_CONTENT).css("padding-right") || 0, 10);
                    ...
                    value: function t(e, n) {
                        return this.each(function() {
                            var t = $(this).data(i),
                                o = $.extend({}, s.Default, $(this).data(), "object" == typeof e && e);
                            if (t || (t = new s(this, o), $(this).data(i, t)), "string" == typeof e) {
                                if (void 0 === t[e]) throw new Error('No method named "' + e + '"');
                                t[e](n)
                            } else o.show && t.show(n)
                        })
                    }
                }, {
                    key: "VERSION",
    ...
    function i(i) {
        ...
        if ("" === s.value) {
            if ("password" === s.type) {
                ...
                var a = o.data("placeholder-password");
                a && (a[0].value = "", o.attr("id", o.data("placeholder-id")).show().nextAll('input[type="password"]:last').hide().removeAttr("id"))
            }
...
vjs.CDN_VERSION = "4.12", vjs.ACCESS_PROTOCOL = "https:" == document.location.protocol ? "https://" : "http://", vjs.VERSION = "4.12.11", vjs.options = {
    ...
    n.handlers || (n.handlers = {}), n.handlers[e] || (n.handlers[e] = []), i.guid || (i.guid = vjs.guid++), n.handlers[e].push(i), n.dispatcher || (n.disabled = !1, n.dispatcher = function(e) {
        if (!n.disabled) {
            ...
            if (i)
                for (var s = i.slice(0), o = 0, r = s.length; o < r && !e.isImmediatePropagationStopped(); o++) s[o].call(t, e)
        }
...
vjs.createEl = function(t, e) {
        ...
        return t = t || "div", e = e || {}, i = document.createElement(t), vjs.obj.each(e, function(t, e) {
            t.indexOf("aria-") !== -1 || "role" == t ? i.setAttribute(t, e) : i[t] = e
        }), i
    ...
    function() {
        ...
        if (e = {}, i = ",autoplay,controls,loop,muted,default,", t && t.attributes && t.attributes.length > 0) {
            n = t.attributes;
            for (var r = n.length - 1; r >= 0; r--) s = n[r].name, o = n[r].value, "boolean" != typeof t[s] && i.indexOf("," + s + ",") === -1 || (o = null !== o), e[s] = o
        }
        return e
        ...
        var i = Math.floor(t % 60),
            ...
            r = Math.floor(e / 3600);
        return (isNaN(t) || t === 1 / 0) && (s = n = i = "-"), s = s > 0 || r > 0 ? s + ":" : "", n = ((s || o >= 10) && n < 10 ? "0" + n : n) + ":", i = i < 10 ? "0" + i : i, s + n + i
        ...
        try {
            ...
            22 == t.code || 1014 == t.code ? vjs.log("LocalStorage Full (VideoJS)", t) : 18 == t.code ? vjs.log("LocalStorage not allowed (VideoJS)", t) : vjs.log("LocalStorage Error (VideoJS)", t)
        }
        ...
        if (vjs.obj.isArray(t) && e instanceof Function)
            for (var n = 0, s = t.length; n < s; ++n) e.call(i || vjs, t[n], n, t);
        return t
        ...
        if (void 0 !== e) return (null === e || vjs.isNaN(e)) && (e = 0), ("" + e).indexOf("%") !== -1 || ("" + e).indexOf("px") !== -1 ? this.el_.style[t] = e : "auto" === e ? this.el_.style[t] = "" : this.el_.style[t] = e + "px", i || this.trigger("resize"), this;
        if (!this.el_) return 0;
        var n = this.el_.style[t],
            s = n.indexOf("px");
        return s !== -1 ? parseInt(n.slice(0, s), 10) : parseInt(this.el_["offset" + vjs.capitalize(t)], 10)
        ...
        t = 0, e = null, l = 10, h = 200, this.on("touchstart", function(i) {
            ...
            e = null, n === !0 && (i = (new Date).getTime() - t, i < h && (s.preventDefault(), this.trigger("tap")))
        })
        ...
        if (this.el_) {
            var t, e = this.getPercent(),
                i = this.handle,
                n = this.bar;
            if (("number" != typeof e || e !== e || e < 0 || e === 1 / 0) && (e = 0), t = e, i) {
                var s = this.el_,
                    o = s.offsetWidth,
                    r = i.el().offsetWidth,
                    a = r ? r / o : 0,
...
if (function() {
        ...
        if (e = vjs.getElementAttributes(t), i = e["data-setup"], null !== i && vjs.obj.merge(e, vjs.JSON.parse(i || "{}")), vjs.obj.merge(n, e), t.hasChildNodes()) {
            var s, o, r, a, l;
            for (s = t.childNodes, a = 0, l = s.length; a < l; a++) o = s[a], r = o.nodeName.toLowerCase(), "source" === r ? n.sources.push(vjs.getElementAttributes(o)) : "track" === r && n.tracks.push(vjs.getElementAttributes(o))
        }
        return n
        ...
        var t = this.player_.volume(),
            e = 3;
        0 === t || this.player_.muted() ? e = 0 : t < .33 ? e = 1 : t < .67 && (e = 2), this.player_.muted() ? this.el_.children[0].children[0].innerHTML != this.localize("Unmute") && (this.el_.children[0].children[0].innerHTML = this.localize("Unmute")) : this.el_.children[0].children[0].innerHTML != this.localize("Mute") && (this.el_.children[0].children[0].innerHTML = this.localize("Mute"));
    ...
    function() {
        ...
        var i = t.indexOf("&"),
            n;
        return i !== -1 ? n = i + 1 : (i = n = t.lastIndexOf("/") + 1, 0 === i && (i = n = t.length)), e.connection = t.substring(0, i), e.stream = t.substring(n, t.length), e
        ...
        vjs.TextTrack = function(e) {
            ...
            if (n.player_ = e.player, o = vjs.TextTrackMode[e.mode] || "disabled", r = vjs.TextTrackKind[e.kind] || "subtitles", a = e.label || "", l = e.language || e.srclang || "", s = e.id || "vjs_text_track_" + vjs.guid++, "metadata" !== r && "chapters" !== r || (o = "hidden"), n.cues_ = [], n.activeCues_ = [], h = new vjs.TextTrackCueList(n.cues_), c = new vjs.TextTrackCueList(n.activeCues_), p = !1, u = vjs.bind(n, function() {
                    ...
                    get: function() {
                        ...
                        for (s = this.player_.currentTime(), t = 0, e = this.cues.length, n = []; t < e; t++) o = this.cues[t], o.startTime <= s && o.endTime >= s ? n.push(o) : o.startTime === o.endTime && o.startTime <= s && o.startTime + .5 >= s && n.push(o);
                        if (p = !1, n.length !== this.activeCues_.length) p = !0;
                        else
                            for (t = 0; t < n.length; t++) i.call(this.activeCues_, n[t]) === -1 && (p = !0);
                        return this.activeCues_ = n, c.setCues_(this.activeCues_), c
                    },
                    set: Function.prototype
                }), e.src ? t(e.src, n) : n.loaded_ = !0, vjs.IS_IE8) return n
            ...
            for (var e = 0, i = this.cues_.length, n, s = !1; e < i; e++) n = this.cues_[e], n === t && (this.cues_.splice(e, 1), s = !0);
    ...
    function() {
        ...
        for (var e = 0, i = this.length, n = null, s; e < i; e++)
            if (s = this[e], s === t) {
        ...
        if (vjs.TextTrackCueList.prototype.setCues_.call(e, t), Object.defineProperty(e, "length", {
                get: function() {
                    return this.length_
                }
            }), vjs.IS_IE8) return e
    ...
    function() {
        ...
        vjs.TextTrackDisplay.prototype.updateDisplay = function() {
            ...
            for (var t = this.player_.textTracks() || [], e = 0, i = t.length, n, s, o = this.items = []; e < i; e++)
            ...
            if (void 0 === r && (r = new vjs.Menu(this.player_), r.contentEl().appendChild(vjs.createEl("li", {
                ...
                var a = s.cues,
                    l, h;
                for (e = 0, i = a.length; e < i; e++) l = a[e], h = new vjs.ChaptersTrackMenuItem(this.player_, {
                    track: s,
                    cue: l
...
vjs.autoSetup = function() {
        var t, e, i, n, s, o = document.getElementsByTagName("video"),
            ...
            a = [];
        if (o && o.length > 0)
            for (n = 0, s = o.length; n < s; n++) a.push(o[n]);
        if (r && r.length > 0)
            for (n = 0, s = r.length; n < s; n++) a.push(r[n]);
        if (a && a.length > 0)
    ...
    function(t, e) {
        ...
        function o(t, e, o) {
            ...
            var c = "",
                ...
                w = 50,
                T = "middle";
            if (Object.defineProperty(a, "id", s({}, h, {
                    get: function() {
                        return c
                    },
                    set: function(t) {
        ...
        function p(t, e, i, n) {
            ...
            if (r.snapToLines) {
                ...
                var p = o.lineHeight,
                    ...
                    v = i[c] + p,
                    f = h[0];
                Math.abs(d) > v && (d = d < 0 ? -1 : 1, d *= Math.ceil(v / p) * p), a < 0 && (d += "" === r.vertical ? i.height : i.width, h = h.reverse()), o.move(f, d)
            } else {
                var y = o.lineHeight / i.height * 100;
                switch (r.lineAlign) {
                    case "middle":
                        a -= y / 2;
                        break;
                    ...
                    for (var u = !1; l.buffer;) {
                        ...
                        switch (u ? u = !1 : h = i(), l.state) {
                            ...
                            case "ID":
                                ...
                                if (!h) continue;
                                if (l.cue = new(l.vttjs.VTTCue || l.window.VTTCue)(0, 0, ""), l.state = "CUE", h.indexOf("-->") === -1) {
                                    l.cue.id = h;
                                    continue
                                }
                            case "CUE":
    ...
    function() {
        ...
        var n = i.helpers = {},
            ...
            y = n.amd = "function" == typeof define && define.amd,
            ...
            x = n.calculateScaleRange = function(t, e, i, n, s) {
                ...
                for (var c = Math.abs(l - h), u = k(c), p = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), d = n ? 0 : Math.floor(h / (1 * Math.pow(10, u))) * Math.pow(10, u), v = p - d, f = Math.pow(10, u), y = Math.round(v / f);
                    (y > r || 2 * y < r) && !a;)
                    if (y > r) f *= 2, y = Math.round(v / f), y % 1 !== 0 && (a = !0);
                    else if (s && u >= 0) {
                    if (f / 2 % 1 !== 0) break;
                    f /= 2, y = Math.round(v / f)
                } else f /= 2, y = Math.round(v / f);
                return a && (y = o, f = v / y), {
                    steps: y,
                    stepValue: f,
                    min: d,
            ...
            L = n.animationLoop = function(t, e, i, n, s, o) {
                var r = 0,
                    ...
                    l = function() {
                        ...
                        var i = r / e,
                            h = a(i);
                        t.call(o, h, i, r), n.call(o, h, i), r < e ? o.animationFrame = I(l) : s.apply(o)
                    };
                I(l)
            },
        ...
        i.instances = {}, i.Type = function(t, e, n) {
                ...
                if (o || e) {
                    if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)
                        if (this.datasets && this.datasets.length > 1) {
                            for (var r, a, h = this.datasets.length - 1; h >= 0 && (r = this.datasets[h].points || this.datasets[h].bars || this.datasets[h].segments, a = l(r, t[0]), a === -1); h--);
                            var c = [],
                                u = [],
                                p = function(t) {
                                    var e = [],
            ...
            draw: function() {
                ...
                this.display && (t.fillStyle = this.textColor, t.font = this.font, s(this.yLabels, function(s, o) {
                    ...
                    0 !== i || r || (r = !0), r && t.beginPath(), i > 0 ? (t.lineWidth = this.gridLineWidth, t.strokeStyle = this.gridLineColor) : (t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor), r && (t.moveTo(s, this.endPoint), t.lineTo(s, this.startPoint - 3), t.stroke(), t.closePath()), t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor, t.beginPath(), t.moveTo(s, this.endPoint), t.lineTo(s, this.endPoint + 5), t.stroke(), t.closePath(), t.save(), t.translate(n, o ? this.endPoint + 12 : this.endPoint + 8), t.rotate(w(this.xLabelRotation) * -1), t.font = this.font, t.textAlign = o ? "right" : "center", t.textBaseline = o ? "middle" : "top", t.fillText(e, 0, 0), t.restore()
                }, this))
            }
            ...
            setScaleSize: function() {
                ...
                u = l, p = Math.ceil(o - this.width), a = this.getIndexAngle(r), c = this.getIndexAngle(h), d = p / Math.sin(a + Math.PI / 2), v = u / Math.sin(c + Math.PI / 2), d = g(d) ? d : 0, v = g(v) ? v : 0, this.drawingArea = t - (v + d) / 2, this.setCenterPoint(v, d)
            },
                    ...
                    if (s(this.yLabels, function(e, i) {
                        ...
                        for (var e = this.valuesCount - 1; e >= 0; e--) {
                            ...
                            var o = this.labels.length,
                                ...
                                l = e < a || e > o - a,
                                h = e === a || e === o - a;
                            0 === e ? t.textAlign = "center" : e === r ? t.textAlign = "center" : e < r ? t.textAlign = "left" : t.textAlign = "right", h ? t.textBaseline = "middle" : l ? t.textBaseline = "bottom" : t.textBaseline = "top", t.fillText(this.labels[e], n.x, n.y)
                        }
                    }
                }
            }
        ...
        e.Type.extend({
            ...
            getPointsAtEvent: function(t) {
                var e = i.getRelativePosition(t),
                    ...
                    r = [];
                return (o >= this.scale.valuesCount || o < 0) && (o = 0), n.distance <= this.scale.drawingArea && i.each(this.datasets, function(t) {
                    r.push(t.points[o])
                }), r
            },
            buildScale: function(t) {
